/**
 *  Woox Temperature Humidity Sensor
 *  Version 1.0
 *
 *
 ...
 *
 *  Original device handler code by a4refillpad, adapted for use with Woox model by KasperGS
 *  Additional contributions to code by alecm, alixjg, bspranger, cscheiene, gn0st1c, foz333, jmagnuson, rinkek, ronvandegraaf, snalee, tmleafs, twonk, veeceeoh & KasperGS 
 * 
 *  Known issues:
 *  Woox sensors do not seem to respond to refresh requests
...
metadata {
	definition (name: "Woox Temperature And Humidity Sensor", namespace: "KasperGS", author: "KasperGS") {
    ...
    tiles(scale: 2) {
        ...
        valueTile("humidity", "device.humidity", inactiveLabel: false, width: 2, height: 2) {
            state "humidity", label:'${currentValue}%', unit:"%", icon:"https://raw.githubusercontent.com/Cashper/Woox-Temperature-Humidity-Sensor-ST-DH/main/images/WooxHumidity.png",
            backgroundColors:[
        ...
        standardTile("pressure", "device.pressure", inactiveLabel: false, decoration:"flat", width: 2, height: 2) {
            state "pressure", label:'${currentValue}', icon:"https://raw.githubusercontent.com/Cashper/Woox-Temperature-Humidity-Sensor-ST-DH/main/images/WooxPressure.png"
        }
        valueTile("battery", "device.battery", inactiveLabel: false, width: 2, height: 2) {
            state "battery", label:'${currentValue}%', unit:"%", icon:"https://raw.githubusercontent.com/Cashper/Woox-Temperature-Humidity-Sensor-ST-DH/main/images/WooxBattery.png",
            backgroundColors:[
